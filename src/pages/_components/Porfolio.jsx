...
function Porfolio() {
  ...
  //     href: "https://xmed.uz/",
  //     img: "/image/Xmed.png",
  //     title: t("portfolioSection.projects.2.title"),
  //     body: t("portfolioSection.projects.2.body"),
  //   },
  // ];

  return (
    <div className="space-y-[30px] mb-10">
      <div className=" h-[99px] bg-black/40"></div>
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 max-w-[1440px] mx-auto ">
        {/* {data.map((d) => (
          ...
          >
            <div
              className={`group border border-[#0349A71A] rounded-2xl p-4 bg-white space-y-[20px] overflow-hidden ${
                darkMode ? "hover:shadow-xl hover:shadow-gray-300" : ""
              } `}
            >
              ...
              <div className="flex justify-between items-center m-2">
                <div className="flex flex-col items-start space-y-2">
                  <h1 className="font-bold text-2xl">{d.title} {d.body}</h1>
