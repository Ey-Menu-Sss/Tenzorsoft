...
//         <button
//           onClick={prev}
//           className="absolute left-4 top-1/2 -translate-y-1/2 bg-blue-600 text-white w-10 h-10 rounded-full z-30 hover:bg-blue-700"
//         >
...
//             } else if (offset === 1) {
//               className += " translate-x-[220px] z-15 scale-90 opacity-80";
//             } else if (offset === 2) {
...
//         <button
//           onClick={next}
//           className="absolute right-4 top-1/2 -translate-y-1/2 bg-blue-600 text-white w-10 h-10 rounded-full z-30 hover:bg-blue-700"
//         >
//           <div className="flex items center justify-center">
//             <span className="text-2xl mb-1.5">›</span>
//           </div>
